...
def getRaw(output_path, data_type=None):
    ...
    if data_type == "pmos_pdf":
        ...
        get_pdf_links_more_pages(url=url, element_class=element_class, page_num=page_num, search_word=search_word, pdf_dict_file='pdf_link.json',

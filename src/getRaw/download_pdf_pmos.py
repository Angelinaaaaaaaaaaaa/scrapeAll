...
def get_pdf_links_one_page(url, element_class=pmos_element_class, driver=None, button_xpath=None, pdf_dict={}, search_word=None,
                           pdf_dict_file='pdf_link.json', output_path=None):
    if driver is None:
    ...
    try:
        ...
        print("Fail to load webpage or find element.")
...
def get_pdf_links_more_pages(url, element_class=pmos_element_class, driver=None, page_num=1, search_word=None, pdf_dict_file=None,
                             output_path=None):
    for _ in range(page_num):
        driver = get_pdf_links_one_page(url, element_class, driver=driver, search_word=search_word, pdf_dict_file=pdf_dict_file,
